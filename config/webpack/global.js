      ...
      loaders: [
        {
          test: /\.html$/,
          loaders: [
            'html-loader?attrs=source:srcset link:href img:src img:data-src picture:data-src div:data-src a:data-mfp-src a:href source:data-original div:data-mfp-src img:data-original img:scrset source:src img:data-lazy image:href li:data-src div:data-src&interpolate=1',
            'purifycss-loader'
          ]
        },
        {
